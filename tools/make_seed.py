...
SETTINGS = [
    ...
    ["location", "", "Shown in the hero and contact block; leave blank to keep it off the site"],
    ...
    ["resume_url", "", "PDF path or URL for a resume link; leave blank for none"],
...
SETTINGS_NEW = [
    ["show_cv_page", "no", "yes/no - publish cv.html and link to it"],
    ...
    ["show_location", "no", "yes/no - location in hero and contact"],
